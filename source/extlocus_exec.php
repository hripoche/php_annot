...
if ($program == "0") {
  $BIN="/export/home/www/htdocs/php/annot/bin/extlocus";
  $command = "/usr/bin/dos2unix $stdin $stdin ; $BIN $stdin -col $id_type -mod 0 -nmx 1000 -sp $species -o $stdout 2> $stderr";
}
...
<form action="extlocus_output.php" method="get">
<center>
<h1> Annot </h1>
